        ...
        <ScrollView style={styles.scrollView}>
          ...
          <Card style={styles.card}>
            <Card.Content>
              ...
              <Text style={{ fontSize: 20, color: '#2786ff', fontWeight: "bold" }}>R$ 900,00</Text>
              <Text>Limite disponivel <Text style={{ color: '#1e9934', fontWeight: "bold", fontSize: 12 }} > R$ 300,00</Text></Text>
            </Card.Content>
          </Card>
          ...
          <Card style={styles.card}>
            <Card.Content>
              ...
              <Text style={{ fontSize: 20, color: 'black', fontWeight: "bold" }}>R$ 150,90</Text>
            </Card.Content>
          </Card>
          ...
          <Card style={styles.card}>
            <Card.Content>
              ...
              <Text style={{ fontSize: 15, color: 'BLACK', fontWeight: "bold" }}>R$ 5.000,00</Text>
              <Card.Actions>
                <Button style={{ borderColor: '#652279', borderWidth: 0.1, }}>
